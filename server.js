...
//       drainageStructures: ['name', 'description', 'type', 'condition'],
...
//         filteredProperties[key] = String(properties[key]).substring(0, key === 'description' ? 255 : 100);
//       }
//     }
...
//           SELECT UpdateGeometrySRID('${dataset}', 'geom', 4326)
//         `);
//         console.log(`✅ Created table ${dataset} with base schema`);
//       }
//     }
//     console.log('✅ All dataset tables initialized');
//   } catch (err) {
...
const pool = require('./middleware/db');
const { authenticateToken } = require('./middleware/authMiddleware');
const geojsonUpload = require('./routes/geojson');
