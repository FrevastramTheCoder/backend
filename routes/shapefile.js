...
// const { pool, authenticate } = require('../server.js'); // Updated to explicit .js extension
...
// Import pool and authenticate from main server
const { pool, authenticate } = require('../server.js');

// Debug: Log to verify imports
console.log('shapefile.js: typeof router.post:', typeof router.post);
console.log('shapefile.js: typeof authenticate:', typeof authenticate);
